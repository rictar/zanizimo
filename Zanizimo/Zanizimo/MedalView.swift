...
class MedalView: UIImageView {
    ...
    func createMedalImage() -> UIImage {
        ...
        //    let darkGoldColor = UIColor(named: "darkGray")
        //    let midGoldColor = UIColor(named: "silver")
        //    let lightGoldColor = UIColor(named:"lightGray")
        
//        let darkGoldColor = UIColor(named: "darkBronze")
//        let midGoldColor = UIColor(named: "bronze")
//        let lightGoldColor = UIColor(named:"lightBronze")
